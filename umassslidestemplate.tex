...
\title{UMass Beamer Presentation Theme}
...
\framesubtitle{Selecting the UMASS Theme}
To start working with \texttt{umassbeamer}, start a \LaTeX\ document with the
preamble:
\begin{block}{Minimum UMASS Beamer Document}
...
\verb|\footlinecolor{color}|
      ...
      \testcolor{maincolor}, \testcolor{umassyellow}, 
      \testcolor{umassgreen}, \testcolor{umassdarkgreen}
...
\begin{colorblock}[black]{umasslightgreen}{Colour Blocks}
...
\small
\begin{verbatim}
\begin{colorblock}[black]{umasslightgreen}{title}
content...
\end{colorblock}
\end{verbatim}
\end{colorblock}
The ``official'' colours of colour blocks are: \testcolor{umasspurple}, 
\testcolor{maincolor}, \testcolor{umassdarkgreen}, and 
\testcolor{umassyellow}.
\end{column}
\end{columns}
\end{frame}
...
\begin{itemize}[<alert@2>]
  ...
  \item The colours are defined in the \texttt{umasscolor} package:
  \begin{itemize}
  \item Primary colours: \testcolor{maincolor} and its sidekick 
  \testcolor{umassblack}
  \item Three shades of green: \testcolor{umasslightgreen}, 
  \testcolor{umassgreen}, \testcolor{umassdarkgreen}
  \item Additional colours: \testcolor{umassyellow}, \testcolor{umassred}, 
        \testcolor{umasspurple}
        \begin{itemize}
        \item These may be shaded---see the \verb|umasscolor| documentation or 
        the \hrefcol{https://umass.sharepoint.com/sites/stottetjenester/%
        kommunikasjon/grafisk-profil-new/Sider/default.aspx}{UMASS profile 
        manual}
        \end{itemize}
  \end{itemize}
...
\testcolor{umassdarkgreen}, \testcolor{umassgreen}, 
\testcolor{umasslightgreen}, \testcolor{umassred}, \testcolor{umassyellow}, 
\testcolor{umasspurple}.
      \begin{itemize}
